...
## [4.0.4](https://github.com/hodpub/yze-coriolis/compare/v4.0.4...v4.0.4) (2025-11-23)
...
* add ability to have talents add to mind points similarly to how HP buffs work ([ec5e087](https://github.com/hodpub/yze-coriolis/commit/ec5e087ab69c16ff5bf321e42a94d1e500878f44))
* add confirmation dialog on item deletion ([88c9038](https://github.com/hodpub/yze-coriolis/commit/88c9038858152f955ccc0e5213c64606cbcb3314))
* add confirmation dialog on item deletion and fixed localization ([de4a9ce](https://github.com/hodpub/yze-coriolis/commit/de4a9ce928f43f2f259bf2e4aa922b25d9ce649c))
* add post item to chat from the actor sheet ([ef8d1cd](https://github.com/hodpub/yze-coriolis/commit/ef8d1cd16bca338a223047a4fca8673c414c4141))
* add prayer bonus ([7f7b733](https://github.com/hodpub/yze-coriolis/commit/7f7b733d9708463cca1af3a2faca0e32fd72d4f9))
* add related skill icon on prayer button ([7db2806](https://github.com/hodpub/yze-coriolis/commit/7db28069380f181726ae5a44dec684b58d704cd2))
* add related skill icon on prayer button ([3195c67](https://github.com/hodpub/yze-coriolis/commit/3195c67b51b9e7dd938375f7be6f9cf3c59f80d7))
* add related skill icon on prayer button ([90eb6c7](https://github.com/hodpub/yze-coriolis/commit/90eb6c772a00e83b4abd642de55e75f6d46cf592))
* add settings for DP-Display ([4bdb7a0](https://github.com/hodpub/yze-coriolis/commit/4bdb7a0294bce5eb32950fe7d1e838a557d3578b))
* added a display HUD for darkness points for the GM ([1b75e81](https://github.com/hodpub/yze-coriolis/commit/1b75e818a1aeb07a7d3b1311613f864c47f9e6c0))
* added ability to post items to chat ([f616576](https://github.com/hodpub/yze-coriolis/commit/f6165761bd1929f5d692366ab5d84ec19aef36ff))
* added additional data to rolls in chat ([2898881](https://github.com/hodpub/yze-coriolis/commit/2898881ed744cfcb7da2e3ef2687b3c537c9db0c))
* added log books to ships ([919aebd](https://github.com/hodpub/yze-coriolis/commit/919aebddba9cc26d2aec366ae82eba99482a2980))
* added more fields for critical injuries ([4326d61](https://github.com/hodpub/yze-coriolis/commit/4326d614e77d116b1cd2e75a6e46d19ac8ebf730))
* added more modifier options such as "all", blessing and prayers. ([2ba2a6e](https://github.com/hodpub/yze-coriolis/commit/2ba2a6eec570797c940fa605281337dcbd1608ca))
* added movement rate stat to characters and NPCs ([79de6ff](https://github.com/hodpub/yze-coriolis/commit/79de6ff23dea28a374926445a0beb3d488ebed6e))
* added option to display weapon, armor, and explosive features inline. ([7aa9606](https://github.com/hodpub/yze-coriolis/commit/7aa9606bc55ea4780ca1f7072c7fd5fc653488e5))
* added roll visibility to modifier dialog ([48d0494](https://github.com/hodpub/yze-coriolis/commit/48d04940ec7f7e1e9a5ab1496c3b9763be3f7ef0))
* Added weapon features to extended rolls. ([a26d02a](https://github.com/hodpub/yze-coriolis/commit/a26d02a34ae8fe214a020b0757b2eaeea8202c7a))
* Chat visibility selector in the modifier dialog ([12c1f0e](https://github.com/hodpub/yze-coriolis/commit/12c1f0e2d1911281e8da4010c84187630768b44e))
* implement automatic fire ([9d08af4](https://github.com/hodpub/yze-coriolis/commit/9d08af42ac44134af2335d6dcbe8f70a893257e1))
* implement automatic fire ([818cbc7](https://github.com/hodpub/yze-coriolis/commit/818cbc7c7d9cab5787e7180e4422186091401cba))
* introduced item modifiers ([debc278](https://github.com/hodpub/yze-coriolis/commit/debc27843c2822421d96b969f7be9209fb3435be))
* made equipped status toggle encumbrance calculations ([e0ebf44](https://github.com/hodpub/yze-coriolis/commit/e0ebf4490a2d15312ac1d3ad265d15e7eb703510))
* made equipped status toggle encumbrance calculations ([53d5666](https://github.com/hodpub/yze-coriolis/commit/53d56662e99145a6fd4ea91823dd0c1cbaf94a22))
* made roll visibility a system option ([e40df58](https://github.com/hodpub/yze-coriolis/commit/e40df58c4f05b060b146274c0c3f1797b1c1935b))
* migrated actor keyArt into standard image field. Allowing more compatibility with other modules in the FVTT ecosystem! ([9b8c63c](https://github.com/hodpub/yze-coriolis/commit/9b8c63c3a7122921e15ffb708c025333128ccd40))
* quick editing of initiative as it can often change during combat ([206882a](https://github.com/hodpub/yze-coriolis/commit/206882a6559fcb75ce0b945fcf80b03db395ea7c))
* reworked ship modules ([64a2c11](https://github.com/hodpub/yze-coriolis/commit/64a2c111751eae18fb7c539f48799de2f3c6075b))
* roll modifier dialog reworked ([57ac103](https://github.com/hodpub/yze-coriolis/commit/57ac103ad255728a9ba412e998666ea09ff2b4ca))
* show the number of successes in roll details. ([affaff3](https://github.com/hodpub/yze-coriolis/commit/affaff3b4a9611512427bd812aacda45648bbb27))
* updated compatibility for Foundry v11 ([2eb57a6](https://github.com/hodpub/yze-coriolis/commit/2eb57a672145412b92b0a53272faac6694232d3e))
* updated dice images with small numbers ([32c77ca](https://github.com/hodpub/yze-coriolis/commit/32c77cae4ca375b3dc4300170e9a2d10f1822371))
* updated dice images with small numbers. ([7d82000](https://github.com/hodpub/yze-coriolis/commit/7d8200008cbd2790bc540d7e9e0beb541e9c5f88))
* updated item stylings ([cba552a](https://github.com/hodpub/yze-coriolis/commit/cba552a75c51b599b5dd5d7d72a4c47ecd5077da))
* updated support to v12 ([65ecc00](https://github.com/hodpub/yze-coriolis/commit/65ecc00f2e037fa763aaaa5996f3ae86419d8912))
* v10 compatibility ([5183f07](https://github.com/hodpub/yze-coriolis/commit/5183f07bcfb45224aeaa8e7ebda565ca270b54c1))
* v10 compatiblilty ([52c94ef](https://github.com/hodpub/yze-coriolis/commit/52c94efcde2c1185eab4556115df93140f954b2c))


### Bug Fixes

* added DE translations for MaxEnergyPoints and MaxHullPoints ([fe07deb](https://github.com/hodpub/yze-coriolis/commit/fe07debc14fd83b88743c8d2f120f2a662cad14c))
* added internal support for custom journal styling ([b9d344a](https://github.com/hodpub/yze-coriolis/commit/b9d344ad0719f3ea7833ebfa802eec08be93969d))
* added missing german translations ([e441915](https://github.com/hodpub/yze-coriolis/commit/e441915eb9b584948ae8bcc7b298927ae057539c))
* added some missing translations ([3da55f6](https://github.com/hodpub/yze-coriolis/commit/3da55f6a2751c38d0b2f1d85ec1db51c9d5ea71c))
* added TODO for future migration work ([26937f4](https://github.com/hodpub/yze-coriolis/commit/26937f4caa50e22b368cf93a0582e5c5b6c1fec4))
* added translations for item piles ([89562cc](https://github.com/hodpub/yze-coriolis/commit/89562cc4183cd500157d121c86854bf645126cea))
* adding more robust error handling in updater ([d27483d](https://github.com/hodpub/yze-coriolis/commit/d27483d03813ba22d3087d036274dc4f26997bb5))
* adjust ship facts box ([0b0beab](https://github.com/hodpub/yze-coriolis/commit/0b0beab10088e173818ca782a110370e2a0a0c52))
* adjusted spacing for cost field in ship character sheet ([8df84fc](https://github.com/hodpub/yze-coriolis/commit/8df84fc355441d7a3a0204f5ebe646ad3d1cc844))
* allow players to roll their own initiative ([ca02a93](https://github.com/hodpub/yze-coriolis/commit/ca02a93d9b59ad6a1f1b5403b1f4984908aaebc5))
...
* bug with compendium items conflicting with hp bonus modifiers ([a34a0ab](https://github.com/hodpub/yze-coriolis/commit/a34a0ab250c8771f202afa6ddcf4b8e842efee86))
* bump version to 4.0 for v13 support ([0bab325](https://github.com/hodpub/yze-coriolis/commit/0bab325d2909c8b29dd7e0867a797c2cb06982a2))
* can create items in v12 ([300aed9](https://github.com/hodpub/yze-coriolis/commit/300aed936acde1001a23c97c6635594204812a5b))
* changing form handling ([7b45969](https://github.com/hodpub/yze-coriolis/commit/7b45969a6e29befda10f66d887ced0a4feaae614))
* chat listener registration ([7f7e2dd](https://github.com/hodpub/yze-coriolis/commit/7f7e2ddce9b021ef7dd163b7855ac8e827df0ab7))
* chat listener registration ([f8bf04f](https://github.com/hodpub/yze-coriolis/commit/f8bf04fd3ae83a0c2398176dabb0001fb613304d))
* chat listener registration for pop up messages ([14eb678](https://github.com/hodpub/yze-coriolis/commit/14eb678f8eb153afe0c8d94cc33014054c2a5a90))
* clarified options in automatic fire dialog prompt ([9737bd6](https://github.com/hodpub/yze-coriolis/commit/9737bd6b3a17692d6436645fd03f5918849cb142))
* corrected translations for automatic firing dialog. ([73309a0](https://github.com/hodpub/yze-coriolis/commit/73309a0b3f18a98522a3724a59f4513552c899f5))
* corrected typo in path ([9c5e1de](https://github.com/hodpub/yze-coriolis/commit/9c5e1ded3e7f510994a1020350423cdf7edc337d))
* css styling issues with official content ([6f73fa3](https://github.com/hodpub/yze-coriolis/commit/6f73fa3b7aa3b1463034ce16c85f5624eacb0ed0))
* darkness point controls ([a60061a](https://github.com/hodpub/yze-coriolis/commit/a60061aebd92e215f9ed82d786a0ca69faff34c8))
* dice so nice from rolling twice ([7a413d8](https://github.com/hodpub/yze-coriolis/commit/7a413d875df487135fd89ce4594f87c9e4411dcf))
* display of armor rolls correctly ignoring attributes for each roll setting ([26c7111](https://github.com/hodpub/yze-coriolis/commit/26c7111be3aa5f9a362cb26d25c604a7a909bf39))
* errors when doing standard rolls in v11 ([c302c50](https://github.com/hodpub/yze-coriolis/commit/c302c503899128baeba10195f6229499ec96d09e))
* eslint warnings ([d20e28d](https://github.com/hodpub/yze-coriolis/commit/d20e28de72436bb1e16639f2b97db257e4871a23))
* fix collapsing sidebar bug with coriolis stylesheets ([3ce8806](https://github.com/hodpub/yze-coriolis/commit/3ce8806573a15067ac2a2ccd5ddad6607db58034))
* fix item creation issue ([75a8811](https://github.com/hodpub/yze-coriolis/commit/75a881122f2e31090feae28b85f262ab557283ff))
* fix some german localization ([9b11175](https://github.com/hodpub/yze-coriolis/commit/9b11175c9709c783a4ed2a9fe61fc0c0f9abff5a))
* fixed bug with ship images not being sized correctly in ship sheet during mass imports ([95ffc5e](https://github.com/hodpub/yze-coriolis/commit/95ffc5eb24bbbd4e2ec8f007d97f4f97a9c0ebec))
* fixed damage text support for Weapons ([d4e0308](https://github.com/hodpub/yze-coriolis/commit/d4e0308d2bba7eec7f6c9fcc6e118138eb32eea1))
* fixed default image for ships when importing from compendiums ([30879d1](https://github.com/hodpub/yze-coriolis/commit/30879d1166a6e06703098a3291a47f5eb51efbcb))
* fixed incompatibility with v8 users ([eb4d418](https://github.com/hodpub/yze-coriolis/commit/eb4d41851c6b3ea2362db9a475989910824721b6))
* fixed incompatibility with v8 users. For the time being the deprecated statement will exist in v9 until the next version of Coriolis. ([a7a5fa3](https://github.com/hodpub/yze-coriolis/commit/a7a5fa31811b35ab0bc93a4af62af7f871227f75))
* fixed localization issues with DE translations ([03f1383](https://github.com/hodpub/yze-coriolis/commit/03f138338250de1ce87fcfb599ce7d79245a1465))
* fixed migration to properly populate movement Rate for existing actors ([4421a62](https://github.com/hodpub/yze-coriolis/commit/4421a62f32ce6677197cfcc0a7578f614f3381e1))
* fixed wrapping in ship sheet when adding ship logs to nav ([21c553a](https://github.com/hodpub/yze-coriolis/commit/21c553a120d119a0d3dc0d0ce3f9a92bf15fef6c))
* Fixing Bug [#106](https://github.com/hodpub/yze-coriolis/issues/106) - Missing L10n in ShipSheet ([edc983b](https://github.com/hodpub/yze-coriolis/commit/edc983b3e3940aee6243e4c60d21f1f0db8dc0cd))
* fixing CI ([b1bb90d](https://github.com/hodpub/yze-coriolis/commit/b1bb90d5b7e625ba537f1cfde1acbf4e1d0f1aef))
* fixxed fr.json error ([6a232b5](https://github.com/hodpub/yze-coriolis/commit/6a232b5901f8a0cbec31a64d3d72ff6405d1be48))
* for NPCs spend DP instead of increasing it ([2618f88](https://github.com/hodpub/yze-coriolis/commit/2618f88b68d8225bf87833efcbf5498869e3e77c))
* formatting ([60e9be7](https://github.com/hodpub/yze-coriolis/commit/60e9be79e0d1c0ffbbd29c3ded29aede3d2a4d61))
* group explosive properties together ([05b34b6](https://github.com/hodpub/yze-coriolis/commit/05b34b6f12fb4d3b53f63683dd162143363c8171))
* handle defaulting character keyArt when importing from compendiums ([7fb454c](https://github.com/hodpub/yze-coriolis/commit/7fb454c01328d3bd52b0f138b2abd193e4b358d0))
* handle taller portrait images in character sheet without breaking layouts ([e90068f](https://github.com/hodpub/yze-coriolis/commit/e90068fcba0b0d21734201afa37ae4b18b524ab5))
* initiative rolls now support tie breaking by using "1d6+(1d6*0.1)" instead of just a d6. ([f6a1f47](https://github.com/hodpub/yze-coriolis/commit/f6a1f47d3b3b1e81fea9fab26727ef99e70ed545))
* listing of critical injuries now in line with how talents and gear are listed ([109fccb](https://github.com/hodpub/yze-coriolis/commit/109fccb141a0c65c8a87261e4e0a6ebb65d12bc6))
* localized some migration errors ([b5abc9b](https://github.com/hodpub/yze-coriolis/commit/b5abc9b0717b5bfafe375812221cac330aedf1b6))
* made coriolis stylings be applied in v10 settings ([82cfeed](https://github.com/hodpub/yze-coriolis/commit/82cfeeddd17bb3e926346ce65f4d9b9c89d0b7ad))
* made crew portraits better framed in ship sheets ([d3318cb](https://github.com/hodpub/yze-coriolis/commit/d3318cbbaf5e60f6aa967fb8f466f0162a0f1963))
* made custom journal entries use default styling ([0cd357e](https://github.com/hodpub/yze-coriolis/commit/0cd357e0e412c0046cf37ba74f3f50a9cd883ae0)), closes [#130](https://github.com/hodpub/yze-coriolis/issues/130)
* made default ship key art compatible with firefox ([0e1f300](https://github.com/hodpub/yze-coriolis/commit/0e1f30004382835f6231fc797d01890322ddf2c0))
* make flexcol/row scope more specific to sheets to exclude window headers ([924a874](https://github.com/hodpub/yze-coriolis/commit/924a8741dd5e1a9e25aacdd2514b848ff93ef754))
* make setting default to false ([f23a15e](https://github.com/hodpub/yze-coriolis/commit/f23a15e72c636ee8e9cb63dcdce223d30e8b963c))
* make the display only visible to GMs ([301b884](https://github.com/hodpub/yze-coriolis/commit/301b884a80dcca257133c6441957e8daf0ad7f23))
* make update failure more verbose ([5e10c01](https://github.com/hodpub/yze-coriolis/commit/5e10c019a03e078c595a7510a89a45778dd52afb))
* migrate keyart via fvtt official api ([b9bd89e](https://github.com/hodpub/yze-coriolis/commit/b9bd89e5f13994e390a385f8638335090ae70b45))
* migrate talent bonus using standard foundry way of migration ([691f3fc](https://github.com/hodpub/yze-coriolis/commit/691f3fc3ef9daf588e637386b20d2e4e074f87ba))
* modifiers not showing up correctly in roll dialog ([0cc43fe](https://github.com/hodpub/yze-coriolis/commit/0cc43fe7145de953053f08ca61f6f1354d5ed0dc))
* overlay issue with crit injury descriptions ([f9e4a48](https://github.com/hodpub/yze-coriolis/commit/f9e4a48c832189f1918ab04a81dc9d8c9de19f65))
* pushing rolls as GM or a player ([8576f7e](https://github.com/hodpub/yze-coriolis/commit/8576f7e3f152ffb0179340265fc3a770ff66f63e))
* remove add/substract of darkness points and just use the darkness points control HUD. Inspection button is still there. ([ed0759b](https://github.com/hodpub/yze-coriolis/commit/ed0759b20deb16df5fe390a09104da362742b6ae))
* removed deprecated calls to journal sheet styling ([1d95533](https://github.com/hodpub/yze-coriolis/commit/1d9553329362276f0043155b4f38adea7085fe6c))
* scope  flexcol to only apply to sheets ([4e1494a](https://github.com/hodpub/yze-coriolis/commit/4e1494ae8f757eea2498617d8adb065cb03089e6))
* scope  flexcol to only apply to sheets ([e023205](https://github.com/hodpub/yze-coriolis/commit/e02320531a12d73afb1505606d7f7d975655d283))
* scope  flexcol to only apply to sheets ([148f330](https://github.com/hodpub/yze-coriolis/commit/148f33090fe51708765184d1e654ba682aff60a4))
* scope  flexrow to only apply to sheets ([5f3be4b](https://github.com/hodpub/yze-coriolis/commit/5f3be4b0100bd9cd455c47df8e548813c2db2a26))
...
* styling that got broken in v13 update ([9a76020](https://github.com/hodpub/yze-coriolis/commit/9a7602004dedcda7d755750b3d2db7ae6d7c5b9a))
* talent creation no longer breaks actor sheets ([c46d4b3](https://github.com/hodpub/yze-coriolis/commit/c46d4b38fd107334e12b276febc7bcd8513d13d5))
* token IDs are sent correctly to chat options for unlinked tokens. ([2d3ecec](https://github.com/hodpub/yze-coriolis/commit/2d3ecec3cc1224b645a76a0153916519147009ca))
* token IDs are sent correctly to chat options for unlinked tokens. ([b42792b](https://github.com/hodpub/yze-coriolis/commit/b42792b53b9ab0d3f4f321f3ba7ee67eca24d449))
* update data paths ([57a6b1a](https://github.com/hodpub/yze-coriolis/commit/57a6b1a3885d12ea26998d3ca5dba715df76fab9))
* update gitignore ([aca5378](https://github.com/hodpub/yze-coriolis/commit/aca53785bbd82ca079caa3ccf441e6bebade267e))
* update hook callback ([e986ed7](https://github.com/hodpub/yze-coriolis/commit/e986ed7347fea4d50fd1fce38c6ebbc1cfdead7c))
* update swedish translation for 'reputation' ([a61095b](https://github.com/hodpub/yze-coriolis/commit/a61095bb4f1702fc758e65e8de72d1fabf0926e0))
* update wording for english setting ([606cbcf](https://github.com/hodpub/yze-coriolis/commit/606cbcf72d0ff63471c51eae147af8568ae51c4f))
* updated brazilian portugeuse localizations ([9bf3a47](https://github.com/hodpub/yze-coriolis/commit/9bf3a47657de09c1d3e5d88dfdac5ec72ea5b5ec))
* updated ci ([0af9690](https://github.com/hodpub/yze-coriolis/commit/0af9690116afc17a3e8188896f519b69a44869a0))
* updated CSS for v10 module journals ([da82c7a](https://github.com/hodpub/yze-coriolis/commit/da82c7a8a3513439e8c187f4fdf2a34762d196e9))
* updated de localization ([bda14a9](https://github.com/hodpub/yze-coriolis/commit/bda14a91f7f6c08c56c3bd3d25dc44ac3ac5c5fb))
* updated deps for go ([98bd9c2](https://github.com/hodpub/yze-coriolis/commit/98bd9c26fccd3144f8a29d867a1d52141b6c8c5a))
* updated french language files ([251ce95](https://github.com/hodpub/yze-coriolis/commit/251ce950236cfbf5bb1be57961821c3f31d8bc22))
* updated fvtt compatibility settings ([e32450f](https://github.com/hodpub/yze-coriolis/commit/e32450f3560d453a3b5bc7657b703d267fb60f45))
* updated version target for migration ([2c5e568](https://github.com/hodpub/yze-coriolis/commit/2c5e5680d55db300e2fd09c97c35be5939a8ec81))
* updating CI messaging ([a0d6913](https://github.com/hodpub/yze-coriolis/commit/a0d6913440d34ecd0f9b5ecf01621f5d36836c92))
* updating CI messaging ([1835b04](https://github.com/hodpub/yze-coriolis/commit/1835b04c6f5638f5884573a61d9c18419e8df60d))
* use item images if they exist otherwise use default icons when sending to chat ([c2146ac](https://github.com/hodpub/yze-coriolis/commit/c2146ac3d914098143322c9d2dc684fb61411cc7))
* use v9 API for registering new journal sheets ([2d6e39e](https://github.com/hodpub/yze-coriolis/commit/2d6e39ecea181341d4c278d7b9768357cf9cba99)), closes [#139](https://github.com/hodpub/yze-coriolis/issues/139)
* version bump ([296eec5](https://github.com/hodpub/yze-coriolis/commit/296eec5e872d68f984a602819cd04d387b50618c))
* version bump ([73ea4e6](https://github.com/hodpub/yze-coriolis/commit/73ea4e6464cfd391f27f8bf4130a2f18a3a456d1))


### Miscellaneous Chores

* release 4.0.0 ([e2fd019](https://github.com/hodpub/yze-coriolis/commit/e2fd0199a27709fdacb253f2536b88b47bd2ba93))
